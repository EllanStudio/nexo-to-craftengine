//! Official Minecraft 1.21.11 data-generator registry ids.
//!
//! Generated by work/gen-data.mts from legacy/src/minecraft-registries-1.21.11.ts.
...
static ITEM_IDS: LazyLock<HashSet<String>> = LazyLock::new(|| {
    serde_json::from_str::<Vec<String>>(ITEM_IDS_JSON).expect("embedded data must parse")
        .into_iter()
        .collect()
});

static BLOCK_IDS_JSON: &str = r##"[
 "minecraft:acacia_button",
 "minecraft:acacia_door",
 "minecraft:acacia_fence",
 "minecraft:acacia_fence_gate",
...
static BLOCK_IDS: LazyLock<HashSet<String>> = LazyLock::new(|| {
    serde_json::from_str::<Vec<String>>(BLOCK_IDS_JSON).expect("embedded data must parse")
        .into_iter()
        .collect()
});

static JUKEBOX_SONG_IDS_JSON: &str = r##"[
 "minecraft:11",
 "minecraft:13",
 "minecraft:5",
 "minecraft:blocks",
...
static JUKEBOX_SONG_IDS: LazyLock<HashSet<String>> = LazyLock::new(|| {
    serde_json::from_str::<Vec<String>>(JUKEBOX_SONG_IDS_JSON).expect("embedded data must parse")
        .into_iter()
        .collect()
});

static ENTITY_TYPE_IDS_JSON: &str = r##"[
 "minecraft:acacia_boat",
 "minecraft:acacia_chest_boat",
 "minecraft:allay",
...
static ENTITY_TYPE_IDS: LazyLock<HashSet<String>> = LazyLock::new(|| {
    serde_json::from_str::<Vec<String>>(ENTITY_TYPE_IDS_JSON).expect("embedded data must parse")
        .into_iter()
        .collect()
});

static MOB_EFFECT_IDS_JSON: &str = r##"[
...
static MOB_EFFECT_IDS: LazyLock<HashSet<String>> = LazyLock::new(|| {
    serde_json::from_str::<Vec<String>>(MOB_EFFECT_IDS_JSON).expect("embedded data must parse")
        .into_iter()
        .collect()
});

static SOUND_EVENT_IDS_JSON: &str = r##"[
...
static SOUND_EVENT_IDS: LazyLock<HashSet<String>> = LazyLock::new(|| {
    serde_json::from_str::<Vec<String>>(SOUND_EVENT_IDS_JSON).expect("embedded data must parse")
        .into_iter()
        .collect()
});
...
pub fn is_jukebox_song_id(id: &str) -> bool {
    JUKEBOX_SONG_IDS.contains(id)
}

pub fn is_entity_type_id(id: &str) -> bool {
    ENTITY_TYPE_IDS.contains(id)
}

pub fn is_mob_effect_id(id: &str) -> bool {
    MOB_EFFECT_IDS.contains(id)
}

pub fn is_sound_event_id(id: &str) -> bool {
    SOUND_EVENT_IDS.contains(id)
}
...
mod tests {
    ...
    fn registry_membership() {
        assert!(is_item_id("minecraft:stone"));
        assert!(is_block_id("minecraft:acacia_button"));
        assert!(is_sound_event_id("minecraft:entity.pig.ambient"));
        assert!(!is_item_id("minecraft:nope"));
    }
}
